[En](https://github.com/Parad1st/Steam-Legacy/blob/main/README.md) | [Ru](https://github.com/Parad1st/Steam-Legacy/blob/main/README-ru.md)
...
2. Переместите папку `Steam` из архива в любое удобное место.
3. Создайте ярлык для `steam.exe`.
4. Добавьте `-no-cef-sandbox` в конец пути в свойствах ярлыка (пример на фото).

![Preview](https://raw.githubusercontent.com/Parad1st/Steam-Legacy/refs/heads/main/GitHub/Images/SVO.PNG)
